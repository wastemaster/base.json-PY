...
"""
   BaseJsonLib.Models.WriteUserJWTSerializer
...
class WriteUserJWTSerializer(object):

    """Implementation of the 'WriteUserJWTSerializer' model.
    ...
    Attributes:
        timezone (string):  (Acceptable values are: "Africa/Abidjan",
            ...
            "America/Resolute", "America/Rio_Branco", "America/Santa_Isabel",
            ...
            "Asia/Dushanbe", "Asia/Gaza", "Asia/Hebron", "Asia/Ho_Chi_Minh",
            ...
            "Australia/Sydney", "Canada/Atlantic", "Canada/Central",
            "Canada/Eastern", "Canada/Mountain", "Canada/Newfoundland",
            "Canada/Pacific", "Europe/Amsterdam", "Europe/Andorra",
            ...
            "Europe/Zurich", "GMT", "Indian/Antananarivo", "Indian/Chagos",
        ...
        country (string):  (Acceptable values are: "AF", "AX", "AL", "DZ",
            "AS", "AD", "AO", "AI", "AQ", "AG", "AR", "AM", "AW", "AU", "AT",
            "AZ", "BS", "BH", "BD", "BB", "BY", "BE", "BZ", "BJ", "BM", "BT",
            "BO", "BQ", "BA", "BW", "BV", "BR", "IO", "BN", "BG", "BF", "BI",
            "CV", "KH", "CM", "CA", "KY", "CF", "TD", "CL", "CN", "CX", "CC",
            "CO", "KM", "CG", "CD", "CK", "CR", "CI", "HR", "CU", "CW", "CY",
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the WriteUserJWTSerializer class
