...
"""
   BaseJsonLib.Models.InvitationSerializer
...
class InvitationSerializer(object):

    """Implementation of the 'InvitationSerializer' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the InvitationSerializer class
