...
"""
   BaseJsonLib.Models.WhoAmISerializer
...
class WhoAmISerializer(object):

    """Implementation of the 'WhoAmISerializer' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the WhoAmISerializer class
