...
"""
   BaseJsonLib.Models.UserJWTSerializer
...
class UserJWTSerializer(object):

    """Implementation of the 'UserJWTSerializer' model.
    ...
    def __init__(self,
                 **kwargs):
        """Constructor for the UserJWTSerializer class
